UC_Family("Fighter", 30);
UC_FamilyOverride("Vaygr","Fighter", 31);
UC_Family("Fighter_hw1", 150);
--
UC_Family("Corvette", 30);
UC_Family("Corvette_hw1", 90);
--UC_ShipType("MinelayerCorvette",6);
--UC_ShipType("SalvageCorvette",18);
--
UC_Family("Frigate", 35);
UC_FamilyOverride("Kushan","Frigate", 39);
UC_FamilyOverride("Taiidan","Frigate", 39);
...
UC_FamilyOverride("Vaygr", "Capital", 28);
UC_FamilyOverride("Hiigaran", "Capital", 27);
...
--
UC_Family("Utility", 55);
--UC_ShipType("ResourceCollector", 26);
--UC_ShipType("ResourceController", 5);
--UC_ShipType("Probe", 8);
--UC_ShipType("ECMProbe", 8);
--UC_ShipType("ProximitySensor", 8);
--
UC_Family("Resource", 35);
--UC_ShipType("ResourceCollector_hw1", 26);
--UC_ShipType("ResourceController_hw1", 5);
--
UC_Family("NonCombat", 35);
...
--UC_ShipType("CloakGenerator", 6);
--UC_ShipType("GravWellGenerator", 6);
--UC_ShipType("SensorArray", 6);
--
UC_Family("Platform", 35);
