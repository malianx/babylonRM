...
DustCloud = {
	...
	sensorsOutlineColour			= {1.0, 0.3, 0.44, 0.16},	-- the colour of the outline in the SM, also applies to Nebulii
...
Avoidance = {
	...
	formationPathfindRadiusMultiplier		= 1.1,				-- Formation Pathfinder: This is how many times the radius of the ship is used to find a path around.
	formationPathfindRadiusAddition		= 50.0,				-- Formation Pathfinder: Additional radius used in formation path finding
	...
	extraShipAvoidanceDistance			= 25.0,				-- The extra distance used when finding paths around other ships.
