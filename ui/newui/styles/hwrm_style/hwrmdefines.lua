...
PANEL_PAD_HORIZ = 2/960			-- How far the children are from the edges of a panel
...
COLOR_BUTTON_BGRD_PRESSED = {92, 209, 229, 255}
...
------------------- Tab Color Defines ------------------
COLOR_TAB_BACKGROUND_DEFAULT	= {0,0,0,0}
...
COLOR_TAB_BORDER_PRESSED 		= COLOR_BUTTON_BGRD_HOVER
...
STD_BUTTON_SURFACE = {
			...
			{ prop = "tint_2", float4 = COLOR_BUTTON_BGRD_PRESSED },
...
FACILITY_BUTTON_SURFACE = {
			...
			{ prop = "tint_0", float4 = COLOR_BUTTON_TEXT_DEFAULT },
			{ prop = "tint_1", float4 = COLOR_BUTTON_TEXT_HOVER },
			{ prop = "tint_2", float4 = COLOR_RED_SOLID },
			{ prop = "tint_d", float4 = COLOR_GREEN_SOLID },
			}
...
T_Text_TitleBar = {
    ...
    MENU_RADIOBUTTON_GRAPHIC = {
		...
		Surface = {
			...
			{ prop = "state2", float3 = { 0.0, 0.0, 0.0 } },
			{ prop = "decal", float3 = { 0.0, 0.0, 0.0 } },
			{ prop = "tint_0", float4 = {27, 69, 85, 255} },
			{ prop = "tint_1", float4 = {55, 106, 117, 255} },
			{ prop = "tint_2", float4 = {92, 209, 229, 255} },
			{ prop = "tint_d", float4 = { 255.0, 0.0, 0.0, 255.0 } },
		}
	}        
...
if(GetFacilityButton == nil) then
	function GetFacilityButton(_name, _helptip, _hotkeyID, _uvRect)

		local CommandToggleButton = {
			type = "RadioButton",
			name = _name,

			buttonStyle = "RM_TaskbarHD_ButtonTabStyle",
