...
MissionSelect = {
	...
	Campaign_Title_Text = "$3490", -- SINGLE PLAYER GAME	
	Campaign_SubTitle_Text = "$3491", -- MISSION SELECT
	Campaign_Choose_Text = "$3492", -- CHOOSE MISSION//
	Tutorial_Title_Text = "$3450", -- TUTORIAL
	Tutorial_SubTitle_Text = "$3462", -- LEARN TO PLAY
	Tutorial_Choose_Text = "$3451", -- CHOOSE TUTORIAL//
	--$3613  More Info
