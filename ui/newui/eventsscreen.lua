...
EventsScreen = {
	...
	Layout = {
		pivot_XY = { 0.0, 0.0 },					
		pos_XY = {	x=32/800, y=80/600, xr="scr", yr="scr",},	
		size_WH = {	w = LAUNCHMENUWIDTH, h = .2, wr = "scr", hr = "scr" },	
		--max_WH = { w = LAUNCHMENUWIDTH, h = .25, wr="scr",hr="scr"},
	},
	eventOpaque = 0,
	onShow = "UI_HideScreen('UnitCapInfoPopup'); UI_HideScreen('BuildQueueMenu')",
	--Regions = {
	--	{0,0,22,-1}, -- -1 means resize region to screen height
	--},	
