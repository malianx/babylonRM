...
if(GetCommandButton == nil) then
	function GetCommandButton(_name, _helptip, _hotkeyID, _texture, _mouseclick)
...
------------------
if(GetCommandToggleButton == nil) then
	function GetCommandToggleButton(_name, _helptip, _hotkeyID, _texture, _mouseclick, _mouserightclick)
...
BTN_CMD_SPEEDBOOST		= GetCommandButton("btnSpeedActivate",	"$2959", 173,	"DATA:UI\\NewUI\\Taskbar\\CommandIcons\\cmd_ico_speedburst.dds",		"MainUI_UserEventData( eCustomActivate, 3 );")   				
